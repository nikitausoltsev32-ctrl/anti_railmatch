...
- [x] **Phase 2: Telegram уведомления** — Уведомления о ставках, сообщениях, статусах (completed 2026-03-27)
...
- [ ] **Phase 7: Рейтинг пользователей** — Система оценок по звёздам (1–5) после завершения сделки
