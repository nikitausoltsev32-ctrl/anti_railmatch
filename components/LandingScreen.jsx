            ...
            <section className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 text-center relative mt-6 sm:mt-10 lg:mt-0 pb-10 sm:pb-16">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full max-w-2xl mx-auto animate-in fade-in zoom-in-95 duration-1000 delay-300">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex-1 py-6 bg-[#229ED9] hover:bg-[#1a8bbf] text-white font-black uppercase tracking-widest text-sm rounded-3xl shadow-xl hover:shadow-2xl hover:-translate-y-1.5 active:scale-95 transition-all flex items-center justify-center gap-3"
                    >
