...
export default function LandingScreen({ onStart, onLogin, onDemo, isDark, setIsDark, onShowTerms }) {
    return (
        <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#0B1120] text-slate-900 dark:text-white overflow-hidden bg-grid-pattern">
            ...
            <section className="max-w-7xl mx-auto w-full px-6 py-24">
                <div className="text-center mb-20">
                    <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 font-bold text-xs mb-6 border border-blue-100 dark:border-blue-800">
                        <Sparkles className="w-3.5 h-3.5" /> Простой старт
                    </div>
                    <h2 className="text-4xl md:text-6xl font-black tracking-tight mb-6 dark:text-white">Как это работает?</h2>
                    <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-medium">От регистрации до заключения сделки — три простых шага</p>
                </div>
                    ...
                    {[
                        {
                            ...
                            desc: 'Грузоотправитель публикует заявку на перевозку, а владелец вагонов — свободный подвижной состав. AI-агент поможет заполнить всё за 30 секунд.',
                        ...
                        },
                        {
                            ...
                            desc: 'Биржа автоматически подбирает лучшие предложения. Используйте фильтры по типу вагона, направлению и цене для точного поиска.',
            ...
            <section className="max-w-7xl mx-auto w-full px-6 py-24">
                <div className="text-center mb-20">
                    <h2 className="text-4xl md:text-6xl font-black tracking-tight mb-6 dark:text-white">Возможности платформы</h2>
                    <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-medium">Всё необходимое для эффективной работы на рынке ж/д перевозок</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        { icon: <Sparkles className="w-6 h-6" />, title: 'AI-агент', desc: 'Создавайте заявки голосом или текстом. Агент понимает «10 крытых из Москвы в Челябинск» и заполнит форму автоматически.', bg: 'bg-blue-50 dark:bg-blue-900/30', text: 'text-blue-600 dark:text-blue-400' },
